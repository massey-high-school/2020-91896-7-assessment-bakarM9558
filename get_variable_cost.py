...
def not_blank(question, error,_msg, mum_ok):
    error = error_msg
...
while stop != "xxx":
    ...
    amount = num_check("What us the amount for the ingredient? ")
    ...
    # If exit code is not entered, add ingredient to list
        ...
        get_ingredient = not_blank("Please typr in an ingredients name: ",
                                   "This can't be blank",
                                   "yes")
